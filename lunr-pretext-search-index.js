...
},
{
  ...
  "body": " An Informal Scientific Method   Scientific methodology is a two-step process of making observations and formulating ideas based on those observations. In many cases, the ideas that are formulated lead to the creation of experiments in order to generate additional observations that can be used to refine those ideas.   "
},
{
...
},
{
  ...
  "type": "Section",
  "number": "1.4",
  "title": "Lab Activities: Scientific Method",
  "body": " Lab Activities: Scientific Method  Introduction to the labs   Becoming a Curious Thinker   The first lab activity is designed to cultivate a mind that is curious and willing to ask questions.  Observations, questions, and methods to begin to address the questions.    Explore the classroom    Explore the building    Explore the area around the building    Explore your home.    Here is a concluding piece of text.    "
},
{
  ...
  "body": " Becoming a Curious Thinker   The first lab activity is designed to cultivate a mind that is curious and willing to ask questions.  Observations, questions, and methods to begin to address the questions.    Explore the classroom    Explore the building    Explore the area around the building    Explore your home.    Here is a concluding piece of text.   "
},
{
