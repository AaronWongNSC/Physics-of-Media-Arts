...
},
{
  ...
  "level": "2",
  "url": "sec-calculators.html#sec-calculators-5",
  "type": "Additional Resources",
  "number": "2.1",
  "title": "",
...
{
  "id": "sec-basic-algebra-7",
  "level": "2",
  "url": "sec-basic-algebra.html#sec-basic-algebra-7",
  "type": "Additional Resources",
  "number": "2.4",
  "title": "",
...
},
{
  "id": "sec-position-6-4",
  "level": "2",
  "url": "sec-position.html#sec-position-6-4",
  "type": "Example",
  "number": "4.1.0.1",
  "title": "Two Ways of Measuring Position.",
  "body": " Two Ways of Measuring Position  For this example, we're going to think about two different data collection methods for measuring position. We will imagine trying to create a chart of positions as a person runs a distance of 100 meters.  In the first case, we will imagine measuring the location every second. This will create a chart that has evenly-spaced time increments. Here is how that would look:  INSERT TABLE  In the second case, we will imagine measuring the time every time the runner travels an additional 5 meters. This is how that table would look:  INSERT TABLE  It's not clear that one method is always better than the other. It really depends on what the final goals are. The method more closely mimics what happens with videography, as that typically operates with a constant framerate. However, the second method more closely mimics what happens in actual races, except that in a race we only care about the time it takes to cross the finish line.  "
},
{
  "id": "sec-velocity",
  "level": "1",
