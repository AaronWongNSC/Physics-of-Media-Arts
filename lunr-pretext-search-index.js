...
},
{
  ...
  "body": " Colored Lights and Shadows   Introduction      Equipment List    Red, green, and blue flashlights    Plain white paper (whiter is better) for a \"wall\"    Index card, paper, or thin cardboard to cast shadows.    A pencil or other similarly-shaped object    Scissors    [Optional] A cell phone camera        Procedure  For this lab, we are going to start by using a set of red, blue, and green lights to get a white light. Then we will create shadows and various colors and try to understand the ways that lights are combining to create those colors.    Create a \"wall\" using the white paper. You need a place to shine your lights and create shadows. This could be a piece of paper leaning against a book or a binder, or even just folded in half. It only needs to stand a few inches tall.    Using the paper for the shadows, create two thin strips with a single slit in them. The strips should be few inches wide and the slits should be about a quarter-inch. You will want a clean side edge where the two strips can be brought together like a curtain. The exact dimensions are not important. Use the diagram below as a model.    Line up the three flashlights side-by-side pointing towards the wall. Make a note of which light is in which location.    Darken the room as much as possible and turn on the lights. (Note: If the flashlights have multiple settings, pick the brightest non-blinking option.) Position them so that they combine into a white light in the middle. There may be other colors on the edges, but we're not going to worry about that. From this point forward, you may want to take pictures or video of the lab for future reference.    Hold one of the shadow papers between the lights and the wall. You should see three strips of light of different colors if you move it close enough to the wall. Identify the colors. Hold the second shadow paper between the lights and the first paper. Slide the second paper left and right and pay attention to how the lights and shadows interact with each other. Take a note of what you observe. Remove both papers when you're done.    Hold the pencil between the lights and the wall. You should see three shadows of different colors. Identify the colors. Then place the shadow paper between the lights and the pencil and move it around to see what happens. Then do this again, but with the shadow paper between the lights and the wall.    Put the two shadow papers end-to-end like a closed curtain and position them between the lights and the wall. Slowly separate the two papers to reveal a thin slit. You should see three light lines. Continue pulling the papers apart and watch how the lines spread out. When they touch each other, make a note of the colors that are created. As they continue to get further apart, you will eventually have just two shadows, one from each piece of paper. You may want to make a video recording of this for future reference.      Discussion  After you've completed the tasks, answer the following discussion questions. Some simple diagrams have been included to help you to explain your observations.    In the first phase, you created three lines of light. Explain why the lights appear in the order that they do.    Later in the first phase, you used two slits to create two sets of      Conclusion  ...    Lab Write-Up Guidance  Use the following outline to help you write up your lab report completely and correctly.    Title and Header  ...    Introduction  ...    Procedure  ...    Results and Data  ...    Discussion  ...    Conclusion  ...         Colored Lights and Shadows demonstration      "
},
{
