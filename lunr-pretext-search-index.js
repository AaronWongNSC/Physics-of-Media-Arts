...
},
{
  ...
  "number": "2.2",
  "title": "SI Base Units",
  "body": " SI Base Units    -----   ------    SI  International Bureau of Weights and Measures The units used in modern science are known as SI units. SI stands for the \"International System of Units\" (from the French Système international d'unités ). These units were created by an organization called the International Bureau of Weights and Measures and is an agreed-upon standard that is officially used by almost every country in the world and the entirety of the modern scientific community. We are going to take a brief tour of the seven base units, which form the foundation for all other scientific units.   Seconds   second A second is a unit of time. Measuring the passage of time is something that we use in our daily lives and the second is the smallest common unit of time that we use for that purpose. But the technical definition of a second is somewhat surprising. The statement below is taken from the 9th edition...    [The second] is defined by taking the fixed numerical value of the caesium frequency, , the unperturbed ground-state hyperfine transition frequency of the caesium 133 atom, to be 9 192 631 770 when expressed in the unit Hz, which is equal to .    "
},
{
